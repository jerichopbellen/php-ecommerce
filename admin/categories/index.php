                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="edit.php?id=<?= $row['category_id'] ?>" class="text-primary me-2" title="Edit">
                                        <i class="fa-regular fa-pen-to-square"></i>
                                    </a>
                                    <a href="delete.php?id=<?= $row['category_id'] ?>" class="text-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this category?')">
