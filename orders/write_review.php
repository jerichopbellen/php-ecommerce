...
// Fetch product name, image, and variant details
$query = mysqli_query($conn, "
    ...
    LEFT JOIN product_variants pv 
        ON pv.product_id = p.product_id AND pv.variant_id = $variant_id
          ...
          <form action="send_review.php" method="POST">
            ...
            <?php if ($variant_label): ?>
              <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?= htmlspecialchars($variant_label) ?>" disabled>
              </div>
            <?php endif; ?>
